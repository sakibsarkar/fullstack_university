...
exports.createFaculty = exports.createAdmin = exports.createStudent = void 0;
const catchAsyncError_1 = require("../../../utils/catchAsyncError");
const sendResponse_1 = __importDefault(require("../../../utils/sendResponse"));
const user_service_1 = __importDefault(require("./user.service"));
const { createStudentService, createAdminService, createFacaltyService } = user_service_1.default;
...
exports.createFaculty = (0, catchAsyncError_1.catchAsyncError)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { body } = req;
