...
exports.updateAcademicDeartment = exports.getSingleAcademicDepartment = exports.getAllAcademicDepartments = exports.createAcademicDepartmemt = void 0;
const catchAsyncError_1 = require("../../../utils/catchAsyncError");
const sendResponse_1 = __importDefault(require("../../../utils/sendResponse"));
const academicDepartment_service_1 = require("./academicDepartment.service");
exports.createAcademicDepartmemt = (0, catchAsyncError_1.catchAsyncError)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.getAllAcademicDepartments = (0, catchAsyncError_1.catchAsyncError)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.getSingleAcademicDepartment = (0, catchAsyncError_1.catchAsyncError)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.updateAcademicDeartment = (0, catchAsyncError_1.catchAsyncError)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { departmentId } = req.params;
