...
const auth = (...requiredRoles) => {
    return (0, catchAsyncError_1.catchAsyncError)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (requiredRoles && !requiredRoles.includes(role)) {
            throw new AppError_1.default(401, "You are not authorized  hi!");
        }
        req.user = decoded;
        next();
    }));
